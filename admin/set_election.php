...
<html>
<head>
<title>Election Platform : Set Election</title>
    	...
    	<div class="blankpage-main">
    		<form id="set_election">
			  ...
			  <div class="form-group hide" id="stateselected">
			    ...
			    <select class="form-control" name="election_state" id="election_state">
			    	<option value="empty" disabled="" selected="">Select an election</option>
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="election_year" id="election_year" class="form-control">
			  </div>
